    ...
    <body id="footer">
      ...
      <p>
        *Patty DeMartino provides education, guidance and support, as well as
        ...
        professional medical care, holistic health care is not a substitute for
        the diagnosis, treatment or care of a disease or condition by a medical
        provider. Patty is not a physician, health care professional or
        nutritionist. Holistic health care evaluation, consultation and coaching
        are not intended for the diagnosis of a disease or condition, and any
        assessment tools are intended solely as a guide to developing an
        appropriate health program, set goals, and to monitor progress.
      </p>
